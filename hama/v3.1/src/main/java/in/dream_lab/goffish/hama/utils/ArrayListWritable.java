...
/* http://giraph.apache.org/giraph-core/apidocs/org/apache/giraph/utils/ArrayListWritable.html
...
public abstract class ArrayListWritable<M extends Writable> extends ArrayList<M>
  ...
  /**
   * Using the default constructor requires that the user implement setClass(),
   * guaranteed to be invoked prior to instantiation in readFields()
   */

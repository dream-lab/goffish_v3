...
import in.dream_lab.goffish.giraph.formats.GiraphSubgraphTextInputFormat;
...
public abstract class TextSubgraphInputFormat<I extends WritableComparable,
    ...
    protected abstract class TextVertexReaderFromEachLineProcessed<T> extends
         ...
         *           exception that can be thrown while reading
         */
        protected abstract LongWritable getVId(T line) throws IOException;

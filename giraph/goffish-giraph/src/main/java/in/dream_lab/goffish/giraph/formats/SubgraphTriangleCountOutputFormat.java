...
import in.dream_lab.goffish.giraph.examples.TriangleCountSubgraphValue;
...
public class SubgraphTriangleCountOutputFormat extends
  ...
  private class SimpleTextVertexWriter extends TextVertexWriter {
    ...
    public void writeVertex(
      ...
      ISubgraph<TriangleCountSubgraphValue, NullWritable, NullWritable, LongWritable, NullWritable, LongWritable> subgraph = (ISubgraph) vertex;

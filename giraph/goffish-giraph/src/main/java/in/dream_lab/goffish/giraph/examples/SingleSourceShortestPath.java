 ...
 *
 */
public class SingleSourceShortestPath extends AbstractSubgraphComputation<ShortestPathSubgraphValue, LongWritable, NullWritable, BytesWritable, LongWritable, NullWritable, LongWritable
    > {
